                        				...
                        				<div class="col-xs-7">
                                            ...
                                            <div class="form-group" id="divPhone">
                                                ...
                                                <div class="col-xs-7" id="divPhone1">
                                                	<input type="text" class="form-control" id="phone" name="phone" placeholder="061-345-0267">
                                                </div> 
                                        	</div>  
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" id="divGIndexNumber">
                                        ...
                                        <div class="col-xs-9" id="divGIndexNumber1">
                                           <input type="text" class="form-control" placeholder="Enter id number" name="g_index" id="g_index" autocomplete="off" readonly>  
                                        </div>                    
                                    </div>
                        				...
                        				<div class="col-xs-7">
                                            <div class="form-group" id="divGPhone">
                                                ...
                                                <div class="col-xs-7" id="divGPhone1">
                                                	<input type="text" class="form-control" id="g_phone" name="g_phone" placeholder="061-345-0267" >
                                                </div> 
                                        	</div>
...
$("form").submit(function (e){
	...
	if(index_number == ''){
		...
		$('#divIndexNumber').append('<span id="spanIndexNumber" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" 									 data-toggle="tooltip" title="The id number is required" ></span>');	
	...
	if(g_index_number == ''){
		...
		$('#divGIndexNumber').append('<span id="spanGIndexNumber" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" 									 data-toggle="tooltip" title="The id number is required" ></span>');	
