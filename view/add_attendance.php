                    ...
                    <form role="form" action="../index.php" method="post" id="form1" >
                  		<div class="box-body">
                    		<div class="form-group" id="divIndex">
                      			...
                      			<input type="text" class="form-control" id="index_number" placeholder="Enter id number" name="index_number" autocomplete="off" onChange="this.value">
                    		</div>
                  		</div><!-- /.box-body -->
...
//MSK-000098-form submit	
	...
	if(index == ''){
		...
		$('#divIndex').append('<span id="spanIndex" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The id number is required" ></span>');	
