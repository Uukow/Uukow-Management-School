            			...
            			<div class="panel-body"><!--panel-body -->
                        	<div class="row " id="msk12345">
                                ...
                                <div class="col-xs-4 class-email text-right" style="background-color: aqua;">
                                    	Email: elmanpeace@gmail.com<br>
                                        Phone: 061-345-0267 <br> 
                                </div>
                        	</div>
                            <div class="row ">
                                <div class="col-xs-5">
                                   <h4 style="color: aqua;">INVOICE TO:</h4>
...
if ($row2 !== null) {
    ...
    // Handle the case when $row2 is null
    // You can assign a default value to $inv_number or take any other appropriate action
    $inv_number = 0; // For example, setting it to 0
}

// Continue with your code using $inv_number 
?>                                    
                             ...
                             <table class="table table-bordered">
                                <thead>
								  <tr class="row1">
                                    <th class="th" style="background-color: aqua;">#</th>
                                    <th style="background-color: aqua;">Description</th>
                                    <th class="text-right" style="background-color: aqua;">Fee</th>
                                    <th class="text-right" style="background-color: aqua;">Sub Total</th>
                                  </tr>
                                </thead>
                                <tbody>
<?php
