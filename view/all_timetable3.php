...
if ($row !== null) {
    ...
    $id = null; // Set the id variable to null or handle the case where no data is found
}
...
if ($row1 !== null) {
    ...
    $name = null; // Set the name variable to null or handle the case where no data is found
}
