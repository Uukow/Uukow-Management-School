...
<div class="wrapper">
  <header class="main-header" >
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><strong>UMS</strong></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><strong>Uukow Management School </strong></span>
    </a>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-footer">
						...
						<!-- <div class="pull-middle">
                          <a href="#" class="btn btn-default btn-flat">new user</a>
                        </div> -->
