...
<?php
 ...
 if($_status=="Payments"){
		...
		if ($row1 !== null) 
			$std_name = isset($row1['std_name']) ? $row1['std_name'] : null;
			$due_month = isset($row1['due_month']) ? $row1['due_month'] : null;
			$due_year = isset($row1['due_year']) ? $row1['due_year'] : null;
			$std_index = isset($row1['std_index']) ? $row1['std_index'] : null;
			$notifi_id = isset($row1['notifi_id']) ? $row1['notifi_id'] : null;
		
			// Rest of your code using $std_name, $due_month, $due_year, $std_index, $notifi_id
