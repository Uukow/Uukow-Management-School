...
?>                                    
                             ...
                             <table class="table table-bordered">
                                <thead>
                                    ...
                                    <th class="col-md-2"  style="background-color: aqua;">Amount($)</th>
                                    <th class="col-md-2"  style="background-color: aqua;">Month</th>
                                    <th class="col-md-2"  style="background-color: aqua;">Date</th>
                                </thead>
								<tbody>
                                	<tr id="trBalance1">
